...
1. Known maker gene for mouse hematopoietic stem and progenitor cell [(Nestorowa et al., Blood, 2016)](http://www.bloodjournal.org/content/128/8/e20.long?sso-checked=true#sec-12).

```{r}
knitr::include_graphics("images and figures/F1.large.jpg")
knitr::include_graphics("images and figures/F2.large.jpg")
knitr::include_graphics("images and figures/F3.large.jpg")
